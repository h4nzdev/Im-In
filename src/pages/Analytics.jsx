...
function CustomTooltip({ active, payload, label }) {
  ...
  return (
    <div style={{ background: '#ffffff', border: '1px solid rgba(15,23,42,0.08)', borderRadius: 10, padding: '8px 14px', boxShadow: '0 4px 16px rgba(15,23,42,0.12)' }}>
      ...
      <p style={{ color: '#047857', fontWeight: 700, fontSize: '0.9rem' }}>{payload[0].value}h</p>
    </div>
  );
}
...
export default function Analytics() {
  ...
  const statCards = [
    { label: 'Today',      value: `${todayHours}h`,  color: '#047857', bg: 'rgba(4,120,87,0.1)'  },
    { label: 'This Week',  value: `${weekHours}h`,   color: '#059669', bg: 'rgba(5,150,105,0.1)'  },
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                color: daysFilter === d ? '#047857' : '#64748b',
      ...
      <div className="card glass" style={{ padding: 24, borderRadius: 24, marginBottom: 20 }}>
        ...
        <ResponsiveContainer width="100%" height={180}>
          <AreaChart data={dailyData} margin={{ top: 0, right: 0, left: -20, bottom: 0 }}>
            ...
            <XAxis dataKey="date" tick={{ fill: '#64748b', fontSize: 11, fontWeight: 600 }} axisLine={false} tickLine={false} />
            <YAxis tick={{ fill: '#64748b', fontSize: 11, fontWeight: 600 }} axisLine={false} tickLine={false} />
            <Tooltip content={<CustomTooltip />} cursor={{ stroke: 'rgba(4,120,87,0.3)' }} />
            <Area type="monotone" dataKey="hours" stroke="#047857" strokeWidth={2.5} fill="url(#areaGrad)" dot={{ fill: '#047857', r: 3.5 }} />
          </AreaChart>
        </ResponsiveContainer>
      </div>
      ...
      <div className="card glass" style={{ padding: 24, borderRadius: 24 }}>
        ...
        <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
          {[
            ...
            { label: 'Approved',       value: leaveStats.approved, color: '#047857', bg: 'rgba(16,185,129,0.12)' },
